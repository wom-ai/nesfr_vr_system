...
GST_DEBUG=1 gst-launch-1.0 -v -e aravissrc camera-name=FLIR-1E100147FCEA-0147FCEA ! "video/x-bayer, format=(string)rggb, width=(int)1440, height=(int)1080, framerate=(fraction)$FRAMERATE/1" ! bayer2rgb \
